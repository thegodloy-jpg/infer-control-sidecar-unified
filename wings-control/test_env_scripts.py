...
cmds = _build_base_env_commands(params, 'vllm', '/app')
...
cmds2 = _build_base_env_commands(params, 'sglang', '/app')
...
cmds3 = _build_base_env_commands(params, 'vllm_ascend', '/app')
...
cmds4 = _build_base_env_commands(params, 'mindie', '/app')
