...
def build_start_script(params: Dict[str, Any]) -> str:
    ...
    if engine == "vllm_ascend":
        # start_command.sh is generated by wings-control but executed inside vllm-ascend engine container.
        # The engine container does not include wings-control's /app/app/config/ path.
        # Must use inline image-internal standard paths, not source files from wings-control container.
